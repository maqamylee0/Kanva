...
#include "util.h"
//#include "Bin v1/Level_Index.h"
//#include "Gapped_Bin_new/Bin_Index.h"
//#include "LF_LL.h"
...
private:
    ...
    result_t insert_model_or_bin_lock_free(const key_t &key, const val_t &val, size_t bin_pos, int tid);
