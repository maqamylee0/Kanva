...
#ifndef RNTREE_ADAPTER_H
#define RNTREE_ADAPTER_H
...
#define SIZE 64
#define DATA_STRUCTURE_T nvindex::RN_tree::Btree<K, V, SIZE>
...
// #ifdef USE_TREE_STATS
    class NodeHandler {
    public:
        typedef nvindex::RN_tree::Node<K, V, SIZE>* NodePtrType;
        typedef nvindex::RN_tree::LN<K, V, SIZE>* LeafNodePtrType;
        typedef nvindex::RN_tree::IN<K, V, SIZE>* InnerNodePtrType;
        K minKey;
        K maxKey;
        ...
        size_t getNumKeys(NodePtrType node) {
            return node->isLeaf() ? static_cast<LeafNodePtrType>(node)->slot[0] : 0;
        }
